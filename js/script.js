...
const reactBar = document.querySelector('.bar-react');const barui = document.querySelector('.bar-ui');
...
.fromTo(barui, .75, {width: 'calc(0% - 6px)'}, {width: 'calc(90% - 6px)', ease: Power4.easeout})
...
const showRequiredCategory = event => {
    ...
    getCategory.classList.remove('hideCatergory')
